				...
				<div class="card-body">
					<form:form action="/product/create" method="post" modelAttribute = "product">
						...
						<div class="form-group mb-3">
        					<h5 class="card-title">
							<form:label path="name" class= "mb-3">Product Name: </form:label>
						...
						<div class="form-group mb-3">
        					<h5 class="card-title">
							<form:label path="price" class= "mb-3">Price: </form:label>
							<form:errors path="price" class ="text-danger"/>
							<form:textarea path="price" class="form-control"/>
							</h5>
						</div>
		...
		<div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
  			<div class="card-header">Add Category</div>
  				<div class="card-body bg-light">
    				<h5 class="card-title text-dark">Want to Add a New Category?</h5>
    				<a href="/" class="card-text">Enter the info...</a>
  				</div><!-- close card body -->
		</div><!-- close card -->
 	</div><!-- close container -->
</body>
